...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "populated value mismatches or any source resolves no canonical value for any row "
        "(empty *_ontology_term_id, unrecognized term IDs, or a non-Ensembl var.index), "
