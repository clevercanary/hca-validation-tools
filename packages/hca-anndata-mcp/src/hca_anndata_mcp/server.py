...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "validate_schema afterwards for the verdict; it refuses only what "
        "breaks coherence: the obs index, names containing '/', columns "
        "referenced by uns['batch_condition'], CAP annotation-set columns, "
        "and any file using the deprecated top-level CAP layout, "
