    ...
    * **Uniqueness is a hard gate.** The *entire* resulting index is checked
    ...
    try:
        ...
        with h5py.File(path, "r") as f_in:
            ...
            # read_index hands back one shape for every string encoding
            # (#668, see read_element) and enforces the index contract, since
            # these IDs are matched against the obsm frames' copies below.
