...
""", json_schema_extra = { "linkml_meta": {'alias': 'title',
    ...
    study_dataset_id: str = Field(default=..., title="Study Dataset ID", description="""A unique identifier for each dataset in the study. This should be unique to the study.""", json_schema_extra = { "linkml_meta": {'alias': 'study_dataset_id', 'domain_of': ['Dataset', 'Donor']} })
...
class Sample(ConfiguredBaseModel):
    ...
    donor_id: str = Field(default=..., title="Donor ID", json_schema_extra = { "linkml_meta": {'alias': 'donor_id', 'domain_of': ['Donor', 'Sample']} })
    dataset_id: str = Field(default=..., title="Dataset ID", json_schema_extra = { "linkml_meta": {'alias': 'dataset_id', 'domain_of': ['Sample']} })
